...
public class GUI extends Application {
  ...
  public BorderPane getText() {
    ...
    Text about = new Text("Lorem ipsum dolor sit amet, brute feugait explicari cu vim, \n"
        + "in pri omnesque eligendi detraxit, ut sea elit natum brute.\n"
        + "Delectus persequeris repudiandae quo et. Vocent singulis \n"
        + "disputando sit ea, cum no movet quidam minimum. No malis \n"
        + "efficiendi duo, indoctum tractatos eum in, ea verear voluptatibus \n"
        + " his. Te mea atqui soluta semper, duo tincidunt liberavisse\n"
        + " definitiones ei. Qui at elitr theophrastus vituperatoribus. An \n"
        + "assum homero eum.");
    about.setId("about");
